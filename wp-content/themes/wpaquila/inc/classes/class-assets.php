...
class Assets {
    ...
    public function register_styles() {
        ...
        wp_register_style('bootstrap-css', AQUILA_DIR_URI . '/assets/src/library/bootstrap/css/bootstrap.min.css', [], null, 'all');
        wp_enqueue_style('bootstrap-css');
    }

    public function register_scripts() {
        wp_enqueue_script('main-script', AQUILA_DIR_URI . '/assets/main.js', [], filemtime(AQUILA_DIR_PATH . '/assets/main.js'), true);
        wp_register_script('bootstrap-script', AQUILA_DIR_URI . '/assets/src/library/bootstrap/js/bootstrap.min.js', ['jquery'], null, true);
